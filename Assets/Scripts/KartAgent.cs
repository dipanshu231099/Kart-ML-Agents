...
public class KartAgent : Agent
{
   ...
   public override void OnEpisodeBegin()
   {
      ...
      _kartController.sphere.GetComponent<Rigidbody>().velocity = Vector3.zero;
      _kartController.sphere.GetComponent<Rigidbody>().angularVelocity = Vector3.zero;
      _kartController.sphere.GetComponent<Rigidbody>().rotation = Quaternion.identity;
